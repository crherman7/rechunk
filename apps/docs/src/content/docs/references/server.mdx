...
The default ReChunk instance is located in the `app` directory within this repository. You can run this server locally or host it remotely. This setup allows you to create a ReChunk project and generate a `.rechunkrc.json` configuration file.
