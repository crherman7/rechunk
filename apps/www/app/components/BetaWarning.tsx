...
export const BetaWarning = ({className}: BetaWarningProps) => {
  ...
  return (
    <div
      className={cn(
        'fixed bottom-0 left-0 z-50 w-full text-white',
        'px-4 py-3 shadow-lg md:px-6',
        className,
      )}
      role="alert"
      aria-live="assertive">
      <div className="flex items-center justify-between rounded-lg bg-black p-4">
        <p className="text-[10px]" id="beta-warning-message">
          <strong>ReChunk</strong> is currently in <strong>beta mode</strong>.
          This means the software is still under active development, and while
          we aim to provide a stable and reliable experience, you may encounter{' '}
          ...
          associated with its use. Your feedback and bug reports are invaluable
          in helping us improve and refine <strong>ReChunk</strong>. If you
          encounter any problems or have suggestions for improvement, please let
          us know through our <strong>official issue tracker</strong> or{' '}
          <strong>community channels</strong>. Thank you for your support and
          for helping make <strong>ReChunk</strong> better!
        </p>
        <button
