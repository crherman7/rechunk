...
interface ShinyDivProps extends HTMLMotionProps<'div'> {
  children: React.ReactNode;
  className?: string;
}

export const ShinyDiv = React.forwardRef<HTMLDivElement, ShinyDivProps>(
...
ShinyDiv.displayName = 'ShinyButton';
